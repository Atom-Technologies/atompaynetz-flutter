...
class AtomPaynetz {
  ...
  createSignature(){
      String signatureString = this.login+this.pass+this.ttype+this.prodid+this.txnid+this.amt+this.txncurr;
  ...
  validateSignature({
   mmp_txn,
    ...
    signature
       ...
       String signatureString = mmp_txn+mer_txn+f_code+prod+discriminator+amt+bank_txn;
       var bytes = utf8.encode(signatureString);
